...
{   
    ...
    virtual void visit(ASTIfElseStmt& node)
    {
        ...
        currentSymtab->addChild(localST);   // CHECK: Should you add these local ones as children later, AFTER filling in entries?
